...
Get-AppxPackage *Paint* | Remove-AppxPackage # Paint
...
Get-AppxPackage *Teams* | Remove-AppxPackage # Microsoft Teams
Get-AppxPackage *YourPhone* | Remove-AppxPackage # Your Phone
Get-AppxPackage *ScreenSketch* | Remove-AppxPackage # Snipping Tool
Get-AppxPackage *MicrosoftSolitaireCollection* | Remove-AppxPackage # Microsoft Solitaire Collection
Get-AppxPackage *Windows.Photos* | Remove-AppxPackage # Photos App
Get-AppxPackage *OneDriveSync* | Remove-AppxPackage # OneDrive
